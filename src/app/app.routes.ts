...
export const routes: Routes = [
  {
    ...
    title: 'Search',
    loadComponent: () => import('@home/pages/search/search.component').then(m => m.SearchComponent),
  },
  {
    path: RoutePath.Registration,
    title: 'Sign Up',
    loadComponent: () =>
      import('@auth/pages/registration/registration.component').then(m => m.RegistrationComponent),
  },
  {
  ...
  },
  {
    ...
    title: 'Orders',
    loadComponent: () => import('@orders/orders/orders.component').then(m => m.OrdersComponent),
    canActivate: [AuthGuard],
  },
  {
    path: RoutePath.UserOrders,
    title: 'My Orders',
    loadComponent: () => import('@orders/user-orders/user-orders.component').then(m => m.UserOrdersComponent),
    canActivate: [AuthGuard],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('@admin/pages/stations/stations.component').then(m => m.StationsComponent),
        canActivateChild: [AuthGuard],
      },
      {
        path: RoutePath.AdminCarriages,
        title: 'Admin Carriages',
        loadComponent: () => import('@admin/pages/carriages/carriages.component').then(m => m.CarriagesComponent),
        canActivateChild: [AuthGuard],
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import('@admin/pages/rides/rides.component').then(m => m.RidesComponent),
        canActivateChild: [AuthGuard],
      },
    ],
  },
